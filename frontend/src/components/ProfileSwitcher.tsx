...
export const ProfileSwitcher: React.FC<ProfileSwitcherProps> = ({
  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute left-0 sm:right-0 sm:left-auto mt-2 w-72 bg-white rounded-2xl shadow-xl border border-slate-200/90 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5">
                        ...
                        {profile.isPrimary && (
                          <span className="text-[9px] bg-amber-100 text-amber-700 font-semibold px-1 rounded">
                            Primary
                          </span>
                        )}
                      </div>
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 ml-2">
                    {isSelected && (
                      <span className="p-1 text-amber-600 bg-amber-100 rounded-full">
                        <Check size={12} />
                      </span>
                    )}
                    ...
                    {!profile.isPrimary && onDeleteProfile && (
                      <button
                        ...
                        className="p-1 text-slate-300 hover:text-rose-600 hover:bg-rose-50 rounded-md transition-colors opacity-0 group-hover:opacity-100"
